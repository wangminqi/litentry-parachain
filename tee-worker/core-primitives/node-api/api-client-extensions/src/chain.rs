...
use crate::{ApiResult, Hash, Header, Index, Runtime, SignedBlock};

use sp_core::{storage::StorageKey, Pair};
use sp_finality_grandpa::{AuthorityList, VersionedAuthorityList, GRANDPA_AUTHORITIES_KEY};
use sp_runtime::MultiSignature;
use substrate_api_client::{rpc::Request, Api, ExtrinsicParams, GetBlock, GetHeader, GetStorage};
...
pub trait ChainApi {
	...
	fn get_block_header(&self, header_hash: Option<Hash>) -> ApiResult<Option<Header>>;
...
impl<P: Pair, Client: Request, Params: ExtrinsicParams<Index, Hash>> ChainApi
