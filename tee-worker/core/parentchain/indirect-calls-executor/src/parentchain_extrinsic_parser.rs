...
pub struct SemiOpaqueExtrinsic<'a, SignedExtra> {
	...
	/// Return back the origin extrinsic.
	// pub xt: UncheckedExtrinsicV4<CallIndex, SignedExtra>,
...
pub trait ParseExtrinsic {
	...
	// fn parse(encoded_call: &[u8]) -> Result<UncheckedExtrinsicV4::<CallIndex, Self::SignedExtra>, codec::Error>;
