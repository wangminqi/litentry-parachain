...
use itp_types::{Enclave, RuntimeConfigCollection, ShardIdentifier, H256 as Hash};
...
impl<Runtime: RuntimeConfigCollection> PalletTeerexApi<Runtime> for TestNodeApi {
